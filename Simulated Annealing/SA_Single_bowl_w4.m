...
[x, f, rej, xT, fT, Af, Sf, Si ,BAccR ,sR ,sBlk ,sBlue, maxS] = anneal(rastrigin, parent, struct('Verbosity', 1), d, bias );  % x= final position, f= final energy, rej= rejections in first 100 iterations only, xT= position tracker, fT= energy tracker, Ax= All new positions and Af= All new solution energies, Ai= All solution iterations, Sx= Position accepted, Sf= Energies of accepted positions, Si= A vector containing step number at which acceptance occured, temp_it= iterations at which temp chnages
